...
cascade_path = r"C:\Users\Admin\PycharmProjects\pythonProject_Face_recog\venv\Face_detection\haarcascade_frontalface_default.xml"
...
camera = cv2.VideoCapture(r'group_people.webm') #read video
